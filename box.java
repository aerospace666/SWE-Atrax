		...
		for(int i =0;i<ListOfFiles.length;i++)
		{
			if(ListOfFiles[i].isFile() && (! file.getName().equals(ListOfFiles[i].getName())))
			{
				...
				if(PDoc.getKeywords() == null)
				{
					...
					{
						if((keywordTags[index].equals("NN")) | (keywordTags[index].equals("JJ"))|(keywordTags[index].equals("NNPS")) | (keywordTags[index].equals("VB")) |(keywordTags[index].equals("NNS")) |(keywordTags[index].equals("NNP")))
						{
