...
public class LibraryControl implements Initializable {
    ...
    private Stage getStage() {
    	return (Stage) SlackPane.getScene().getWindow();
    }
    ...
    public void load() {
    	...
    	BookList.add(new Book("Title B", "ID 2", "Author David", "Date 2000"));
