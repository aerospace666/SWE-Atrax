 ...
 * Notice of reference:
 * 
 * This function is copied from http://blog.carl.pro/2016/05/modal-jaxafx-progress-indicator-running-in-background/
 * 
 * As part of showing progress indicator to getfilepath() function in ExtractMedata.java 
 * 
 * These codes are indicated as for sharing to the public, according to the web site (openSource)
 */
